    ...
    <main className="min-h-[100dvh] w-full text-white px-4 overflow-x-hidden">
      ...
      <div className="min-h-[100dvh] flex flex-col items-center text-center pt-5 pb-8">
        <div className="w-full max-w-[360px] relative">
          {/* Logo */}
          <div className="mx-auto mt-1 w-full max-w-[210px] pointer-events-none select-none">
            <img
          ...
          <div className="mt-3 flex flex-col items-center justify-center pointer-events-none">
            <h1 className="text-[30px] sm:text-4xl font-extrabold tracking-tight leading-none text-white">
              {title}
            </h1>

            {subtitle ? (
              <p className="mt-2 text-[13px] font-semibold text-white/70">{subtitle}</p>
            ) : null}
