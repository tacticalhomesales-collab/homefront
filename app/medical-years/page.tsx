...
export default function MedicalYearsPage() {
  ...
  return (
    <AppShell>
      <div className="w-full max-w-md mx-auto">
        <div className="-mt-1 flex flex-col items-center justifyCenter pointer-events-none">
          <h1 className="text-2xl font-extrabold tracking-tight leading-none mb-0.5">
            Years in Healthcare
          </h1>
          <p className="mt-1 text-xs font-semibold text-white/70">
            Select your total years working in healthcare.
          </p>
        </div>
